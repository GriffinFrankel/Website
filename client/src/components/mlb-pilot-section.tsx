        ...
        >
          <div className="grid md:grid-cols-2">
            <div className="relative h-64 md:h-auto">
              <img 
                src="https://images.unsplash.com/photo-1509027572446-af8401acfdc3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1536&q=80"
                className="absolute inset-0 w-full h-full object-cover grayscale opacity-80"
                alt="Excited sports fans cheering at a live sporting event"
              />
