...
export default function BenefitsSection() {
  // References for sticky scroll effect
  ...
  const textY = useTransform(scrollYProgress, [0.1, 0.4], [0, -40]);
  const textOpacity = useTransform(scrollYProgress, [0.1, 0.25, 0.6, 0.8], [0, 1, 1, 0]);
  ...
  return (
    <section ref={sectionRef} id="benefits" className="relative py-20 overflow-hidden min-h-[100vh]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Sticky heading that stays visible while scrolling through benefits */}
        <div className="h-[150vh] relative">
          <motion.div 
            ref={headingRef}
            className="sticky top-32 text-center mb-16 z-20"
            style={{ 
              y: textY,
              opacity: textOpacity
            }}
          ...
          {/* Benefits grid that scrolls past the sticky heading */}
          <div className="pt-[30vh] pb-20">
            ...
            <motion.div 
              className="mt-16 bg-gradient-to-r from-[#0a101f]/90 to-[#111827]/90 backdrop-blur-sm p-8 rounded-xl border border-cyan-500/10 max-w-5xl mx-auto"
