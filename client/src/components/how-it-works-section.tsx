...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how-it-works" className="bg-[#0D1117] py-24 min-h-screen relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Left side - sticky section with title and navigation */}
          ...
          {/* Right side - scrollable content with fixed step content */}
          <div className="md:col-span-7 h-full">
            {/* Scroll targets - these are invisible markers that trigger the active step change */}
            <div className="space-y-[75vh]">
              ...
              {/* Fixed content that shows the active step */}
              <div className="sticky top-1/2 -translate-y-1/2 w-full mb-20">
                {/* Active step content */}
                  ...
                  {steps.map((step) => 
                    activeStep === step.number ? (
                      <motion.div
                        ...
                        className="bg-[#111827] p-6 md:p-8 rounded-xl border border-cyan-500/20 shadow-lg max-w-xl w-full mx-auto"
