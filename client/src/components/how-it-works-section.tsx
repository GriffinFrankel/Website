    ...
    <section id="how-it-works" className="bg-[#0D1117] relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-7 h-[100vh] overflow-y-auto snap-y snap-mandatory pb-40 pt-20">
            {steps.map((step) => (
              <div
                key={step.number}
                id={`step-${step.number}`}
                className="snap-center min-h-[80vh] flex items-center justify-center"
              >
                <motion.div
